...
const TableShowtimeDate = () => {
  ...
  const columns = [
    ...
    {
        title: "Movie Name",
        dataIndex: "movie",  // Reference to the movie object
        render: (text, record) => record.movie ? record.movie.Movie_name : "N/A",  // Access nested Movie_name
        width: '150px',
    },
...
export default TableShowtimeDate;
